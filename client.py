...
from prompts import EXECUTION_GUIDELINES_PROMPT, ARGUMENT_AUTHORITY_EXECUTION_GUIDELINES_PROMPT
        ...
        for message in messages:
            if message["role"] == "system":
                ...
                if initial_trajectory:
                    guidelines_prompt = EXECUTION_GUIDELINES_PROMPT
                    if isinstance(node_checklist, dict) and ("arguments" in node_checklist or "unresolved" in node_checklist):
                        guidelines_prompt = ARGUMENT_AUTHORITY_EXECUTION_GUIDELINES_PROMPT
                        node_checklist = json.dumps(node_checklist, ensure_ascii=False)
                    message["content"] = message["content"] + guidelines_prompt.format(initial_trajectory=initial_trajectory, node_checklist=node_checklist, achieved_trajectory=achieved_trajectory, query=query)
