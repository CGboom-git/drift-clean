...
def get_args(description='DRIFT'):
    ...
    parser.add_argument("--enable_argument_authority_drift", action="store_true")
    parser.add_argument(
        "--aa_global_contract_path",
        type=str,
        default="contracts/agentdojo_ifc_global_tool_contract_semantic_review_gpt55.json",
    )
    parser.add_argument("--aa_contract_model", type=str, default=None)
    parser.add_argument("--aa_debug", action="store_true")
